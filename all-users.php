                                ...
                                <div class="col-sm-12">  
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = array(
                                                'mainCollection' => $customerTable,
                                                'match' => $conduction,
                                                'sort' => array('_id' => 1)
                                            );
                                           
                                            $sqlType = 'nojoin';
                                            $pager = new PS_Pagination($db, $sql, $limit, 5, $append, $sqlType);
                                            $rs = $pager->paginate();
                                            ...
                                            foreach ($rs as $key => $data) {?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit-user.php?id=<?php echo $data['_id']; ?>">
                                                            <i class="fa fa-pencil"></i>Edit
                                                        </a> &nbsp;&nbsp;
                                                        <a href="delete.php?action=delete&table=user&id=<?php echo $data['_id']; ?>">
